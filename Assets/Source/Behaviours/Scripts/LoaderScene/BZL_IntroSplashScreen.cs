...
{
    public class BZL_IntroSplashScreen : StateExtension
    {
        ...
        public override int Evaluate()
        {
            ...
            {
                dataParser.whiteImage.color = Color.Lerp(opaque, transparent, timeElapsed / fadeTime);
                timeElapsed += Time.deltaTime;
                return ExitCodes["Return"];
            }

            dataParser.whiteImage.color = transparent;
            dataParser.whiteImage.enabled = false;
